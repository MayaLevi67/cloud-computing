...
from controllers.books_controller import add_book, get_book, get_books, update_book, delete_book
...
def route_add_book():
    ...
    try:
        ...
        return jsonify({"error": "Invalid JSON data."}), 400 #TODO - what error number should it be ?
...
def route_update_book(book_id):
    ...
    try:
        ...
        return jsonify({"error": "Invalid JSON data."}), 400 #TODO - what should be the code ? is it redundent? 
